...
export default function Projects() {
  ...
  const projects = [
    ...
    // },
    {
      ...
      tags: ['Vanilla JS', 'PWA', 'API', 'HTML5', 'CSS3'],
    ...
    },
    {
      id: 8,
      title: 'DJ App',
      description: 'Dj Maitre Sam PWA music platform, with an admin-backed server setup for managing and updating content.',
      category: 'fullstack',
      image: 'https://res.cloudinary.com/dkd3k6eau/image/upload/v1770598272/professionals/ewpj8xx2g3nxpmelfv6k.jpg',
      tags: ['Javascript', 'Node', 'Render', 'Cloudinary', 'Web3Forms'],
